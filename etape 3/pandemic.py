...
if __name__ == '__main__':
    ...
    while not endSimulation:
        ...
        borderBoxListe = engine.bordingBoxCalculator(persons)
        ...
        for j in range (0, len(persons)):
            ...
            colls = engine.computeCollisions(persons,j,borderBoxListe)
    ...
    endTime = time.time()
    # print average FPS
    print("FPS moyen durant la simulation :", round(frameNumber / (endTime - startTime),2))
    print()
