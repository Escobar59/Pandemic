...
def circleCollision(c1, c2):
    ...
    '''
    left_side1 = c1[0] - constants.PERSON_RADIUS
    right_side1 = c1[0] + constants.PERSON_RADIUS
    left_side2 = c2[0] - constants.PERSON_RADIUS
    right_side2 = c2[0] + constants.PERSON_RADIUS
    
    if left_side1 > right_side2 or left_side2 > right_side1 :
        return False
    else:
        
        up_side1 = c1[1] - constants.PERSON_RADIUS
        down_side1 = c1[1] + constants.PERSON_RADIUS
        up_side2 = c2[1] - constants.PERSON_RADIUS
        down_side2 = c2[1] + constants.PERSON_RADIUS
        
        if up_side1 > down_side2 or up_side2 > down_side1 :
            return False
    return True
...
def computeCollisions(persons, personNumber):
    ...
    for j in range (len(persons)):
        ...
        if ( j != personNumber) and persons[j][2] == constants.INFECTED:
            q = persons[j]
